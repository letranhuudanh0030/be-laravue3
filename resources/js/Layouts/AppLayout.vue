                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('categories.index')" :active="route().current('categories.index')"> Categories </jet-nav-link>
                                <jet-nav-link :href="route('categories.index.recursive')" :active="route().current('categories.index.recursive')"> Categories Recursive</jet-nav-link>
                                <jet-nav-link :href="route('articles.index')" :active="route().current('articles.index')"> Articles </jet-nav-link>
                            </div>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                <jet-dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <jet-dropdown-link :href="route('settings.create')"> Settings </jet-dropdown-link>
